...
public class VagaController {
	...
	public ResponseEntity<String> cadastrar(
			@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Objeto contendo os dados da vaga a ser cadastrada", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = VagaRequestDto.class))) @Valid @RequestBody VagaRequestDto vagaRequestDto) {
